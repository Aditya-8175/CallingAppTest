package com.aditya.callingfunctionality.call

import com.aditya.callingfunctionality.model.TelecomCallRepository
...
import android.telecom.CallEndpoint.TYPE_BLUETOOTH
import android.telecom.CallEndpoint.TYPE_SPEAKER
import android.telecom.CallEndpoint.TYPE_STREAMING
import android.telecom.CallEndpoint.TYPE_WIRED_HEADSET
...
import com.aditya.callingfunctionality.model.TelecomCall
import com.aditya.callingfunctionality.model.TelecomCallAction
    ...
    Row(
        ...
        if (micPermission.status.isGranted) {
            IconToggleButton(
                ...
                if (isMuted) {
                    Icon(imageVector = Icons.Rounded.Call, contentDescription = "Mic on")
                } else {
                    Icon(imageVector = Icons.Rounded.Call, contentDescription = "Mic off")
                }
            }
        } else {
            IconButton(
...
private fun getEndpointIcon(type: @CallEndpointCompat.Companion.EndpointType Int): ImageVector {
    return when (type) {
        TYPE_BLUETOOTH -> Icons.Rounded.AccountBox
        TYPE_SPEAKER -> Icons.Rounded.ShoppingCart
        TYPE_STREAMING -> Icons.Rounded.Send
        TYPE_WIRED_HEADSET -> Icons.Rounded.Build
